            ...
            <div className="login-inner">
                ...
                <form className="login-form" onSubmit={evt => {
                    ...
                    <label className="login-label">
                        <span className="login-label-text">
                            Username
                        </span>
                        <input className="login-input" type="text" placeholder="Enter your username" ref={userNameRef} required/>
                    </label>
                    <label className="login-label">
                        <span className="login-label-text">
                            Password
                        </span>
                        <input className="login-input" type="password" placeholder="Enter your password" ref={passwordRef} required/>
                    </label>
